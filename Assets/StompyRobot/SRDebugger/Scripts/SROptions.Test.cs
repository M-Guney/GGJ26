...
public partial class SROptions
{
    ...
    public void ChangeToDefault()
    {
        ...
        PlayerPrefs.SetInt("TargetLevel", 1);
        PlayerPrefs.SetInt("PlatformMaterial", 0);
        PlayerPrefs.SetFloat("ShotMaxHeight", 2);
        PlayerPrefs.SetString("TrajectoryColor", "FFFFFF");
        PlayerPrefs.SetInt("StopGame", 0);
        CloseSRPanel();
    ...
    public bool StopGame
    {
        get
        {
            if (PlayerPrefs.GetInt("StopGame") == 0)
            {
                return true;
            }
            else
        ...
        set
        {
            OnValueChanged("StopGame", !value);
            GameManager.instance.StopGameControl();
        }
    }
    ...
    [Category("Go Target Level")]
    [NumberRange(1, 23)]
    public int TargetLevel
    {
        get
        {
            if (PlayerPrefs.GetInt("TargetLevel") == 0)
            {
                PlayerPrefs.SetInt("TargetLevel", 1);
            }
            return PlayerPrefs.GetInt("TargetLevel");
        }
        set
        {
            if (value < 1)
            ...
            OnValueChanged("TargetLevel", value);
        }
    }

    [Category("Go Target Level")]
    public void GoTargetLevel()
    {
        if (PlayerPrefs.GetInt("TargetLevel") != 0)
        {
            PlayerPrefs.SetInt("Level", PlayerPrefs.GetInt("TargetLevel") - 1);
        }
        else
        {
            PlayerPrefs.SetInt("Level", 0);
    ...
    [Category("PlayerProperty")]
    [NumberRange(2, 5)]
    public float ShotMaxHeight
    {
        get
        {
            if (PlayerPrefs.GetFloat("ShotMaxHeight") == 0)
            {
                PlayerPrefs.SetFloat("ShotMaxHeight", 2);
            }
            return PlayerPrefs.GetFloat("ShotMaxHeight");
        }
        set
        {
            if (value < 2 || value > 5)
            ...
            OnValueChanged("ShotMaxHeight", value);
            LevelLoader.instance.ChangePlayerShotMaxHeight();
        }
    }

    [Category("PlayerProperty")]
    public string TrajectoryColor
    {
        get
        {
            if (PlayerPrefs.GetString("TrajectoryColor") == "")
            {
                PlayerPrefs.SetString("TrajectoryColor", "FFFFFF");
            }
            return PlayerPrefs.GetString("TrajectoryColor");
        }
        set
        {
            OnValueChanged("TrajectoryColor", value);
            PlayerController.instance.TrajectoryColorChange();
        }
    }
    ...
    public int Skybox
    {
        get
        {
            return PlayerPrefs.GetInt("Skybox", 0);
        }
        set
        {
            OnValueChanged("Skybox", value);
            LevelLoader.instance.SkyboxChange();
        }
    }

    [Category("Theme")]
    [NumberRange(0, 5)]
    public int PlatformMaterial
    {
        get
        {
            return PlayerPrefs.GetInt("PlatformMaterial", 0);
        }
        set
        {
            OnValueChanged("PlatformMaterial", value);
            LevelLoader.instance.PlatformThemeChange();
        }
    }

    private void OnValueChanged(string name, float newValue)
    {
    ...
    private void OnValueChanged(string name, bool newValue)
    {
        if (newValue)
        {
